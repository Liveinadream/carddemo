...
namespace DialogueManagerRuntime
{
  public partial class DialogueBalloon : CanvasLayer
  {
    ...
    {
        // 添加检查确保MutationCooldown对象有效
        if (IsInstanceValid(MutationCooldown))
        {
    ...
    #endregion
    public Card npcCard =null;
    public override void _Process(double delta)
    {
      if(npcCard != null && IsInstanceValid(npcCard)){
        balloon.GlobalPosition = npcCard.GlobalPosition;
      }
    }
  }
